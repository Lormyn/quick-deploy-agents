...
from .tools import flip_a_coin, roll_die

root_agent = Agent(
    model="gemini-2.0-flash",
    name="simple_tools_agent",
    description="A helpful AI assistant. You also can flip a coin or roll a dynamically sided die with your tools.",
    instruction="""
